...
Write-Host "`n📝 Creating .env.local for frontend..." -ForegroundColor Yellow
...
Write-Host "`n📝 Creating .env for backend..." -ForegroundColor Yellow
...
Write-Host "`n📋 DEPLOYMENT VARIABLES TO SET:" -ForegroundColor Magenta

Write-Host "`n🚀 VERCEL (Frontend):" -ForegroundColor Cyan
...
Write-Host "`n🔧 RENDER (Backend):" -ForegroundColor Cyan
